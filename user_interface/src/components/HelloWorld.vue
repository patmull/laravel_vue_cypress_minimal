    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="#" method="POST">
                <div>
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-900">E-mailová adresa</label>
                    <div class="mt-2">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="#"
                               class="font-semibold text-indigo-600 hover:text-indigo-500">Zapomněli jste heslo?</a>
                        </div>
                    </div>
                    <div class="mt-2">
                ...
                <div>
                    ...
                    focus-visible:outline-indigo-600">Přihlásit</button>
                </div>
            </form>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ...
                {{ ' ' }}
                <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Zaregistrovat se</a>
            </p>
        </div>
    </div>
</template>
